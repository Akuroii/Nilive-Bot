...
class Roleplay(commands.Cog):
    ...
    async def hug(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} gives {target} a warm hug!", "{user} wraps their arms around {target}!",
    ...
    async def pat(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} pats {target} on the head!", "{user} gently pats {target}!",
    ...
    async def slap(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} slaps {target} across the face!", "{user} gives {target} a hard slap!",
                    "{user} slaps {target}!"]
        await interaction.response.send_message(
    ...
    async def kiss(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} kisses {target}!", "{user} gives {target} a kiss on the cheek!",
    ...
    async def poke(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} pokes {target}!", "{user} keeps poking {target}!", "{user} sneakily pokes {target}!"]
        await interaction.response.send_message(
    ...
    async def cuddle(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} cuddles with {target}!", "{user} snuggles up to {target}!",
    ...
    async def wave(self, interaction: discord.Interaction, member: discord.Member = None):
        if member:
            messages = ["{user} waves at {target}!", "{user} enthusiastically waves at {target}!"]
            await interaction.response.send_message(
    ...
    async def bite(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} bites {target}!", "{user} takes a chomp out of {target}!",
    ...
    async def cry(self, interaction: discord.Interaction):
        messages = ["{user} bursts into tears!", "{user} is crying!", "{user} starts sobbing!"]
        await interaction.response.send_message(
    ...
    async def dance(self, interaction: discord.Interaction):
        messages = ["{user} starts dancing!", "{user} busts some moves!", "{user} is showing off their dance moves!"]
        await interaction.response.send_message(
    ...
    async def highfive(self, interaction: discord.Interaction, member: discord.Member):
        messages = ["{user} high fives {target}!", "{user} and {target} share a high five!"]
        await interaction.response.send_message(
            embed=self.rp_embed(random.choice(messages), interaction.user, member, discord.Color.green()))
