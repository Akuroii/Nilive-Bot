...
async def init_db():
    ...
    async with aiosqlite.connect(DB_PATH) as db:
        ...
        await db.execute("""
            CREATE TABLE IF NOT EXISTS economy_locks (
                guild_id INTEGER,
                user_id  INTEGER,
                PRIMARY KEY (guild_id, user_id)
            )
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_ml_guild ON moderation_logs(guild_id)")
        await db.execute("CREATE INDEX IF NOT EXISTS idx_ml_user ON moderation_logs(user_id)")
        await db.execute("CREATE INDEX IF NOT EXISTS idx_ml_date ON moderation_logs(created_at)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_wt_guild ON warning_thresholds(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_gs_guild ON guild_settings(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_wm_guild ON welcome_messages(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_lr_guild ON leveling_rewards(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_lbr_guild ON leveling_bonus_roles(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_mvph_guild ON mvp_history(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_si_guild ON shop_items(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_ph_guild ON purchase_history(guild_id)")
        await db.execute("CREATE INDEX IF NOT EXISTS idx_ph_user ON purchase_history(user_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_tr_expires ON temp_roles(expires_at)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_ev_guild ON events(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_tc_guild ON ticket_categories(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_tp_guild ON ticket_panels(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_trat_guild ON ticket_ratings(guild_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_du_guild ON dashboard_users(guild_id)")
        await db.execute("CREATE INDEX IF NOT EXISTS idx_du_user ON dashboard_users(user_id)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_al_guild ON audit_log(guild_id)")
        await db.execute("CREATE INDEX IF NOT EXISTS idx_al_date ON audit_log(created_at)")
        ...
        """)
        await db.execute("CREATE INDEX IF NOT EXISTS idx_ct_guild ON command_toggles(guild_id)")
